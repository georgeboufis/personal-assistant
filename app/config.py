...
class Settings(BaseSettings):
    ...
    # --- Logging ---
    # log_to_file: αν γράφουμε και σε logs/assistant.log (με περιστροφή).
    #     Απαραίτητο για να βλέπεις τι έγινε στην πρωινή ενημέρωση, όταν
    #     δεν κοιτάς το terminal.
    # log_content: αν καταγράφεται ΠΕΡΙΕΧΟΜΕΝΟ (μηνύματα, αποτελέσματα
    #     εργαλείων). ΠΡΟΣΟΧΗ: ενεργοποιώντας το, γράφονται στον δίσκο
    #     αποσπάσματα από τα email σου. Χρησιμοποίησέ το μόνο προσωρινά,
    #     για debugging.
